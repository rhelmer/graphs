...
insert into tests values (NULL,"tp3_nochrome","Tp3 NoChrome",0,1,1);
insert into tests values (NULL,"tp3","Tp3",1,1,1);
insert into tests values (NULL,"tp3_pbytes", "Tp3 (Private Bytes)",1,1,NULL);
insert into tests values (NULL,"tp3_pbytes_nochrome","Tp3 NoChrome (Private Bytes)",0,1,NULL);
insert into tests values (NULL,"tp3_rss","Tp3 (RSS)",1,1,NULL);
insert into tests values (NULL,"tp3_rss_nochrome","Tp3 NoChrome (RSS)",0,1,NULL);
insert into tests values (NULL,"tp3_%cpu","Tp3 (%CPU)",1,1,NULL);
insert into tests values (NULL,"tp3_%cpu_nochrome","Tp3 (%CPU)",0,1,NULL);
insert into tests values (NULL,"tp3_memset","Tp3 (Memset)",1,1,NULL);
insert into tests values (NULL,"tp3_memset_nochrome","Tp3 NoChrome (Memset)",0,1,NULL);
insert into tests values (NULL,"tp3_fast","Tp3 Fast Cycle",1,1,2);
...
insert into tests values (NULL,"tsunspider","SunSpider",1,1,7);
insert into tests values (NULL,"tsunspider_nochrome","SunSpider NoChrome",1,1,7);
